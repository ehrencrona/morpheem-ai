	...
	let { examples } = await askForJson({
		messages: toMessages({
			...
			prompt:
				...
				`Use different styles such news text, fragments of dialog (e.g. in a shop, a workplace or a phone call, do not add the name of the speaker), fairy tales, informal conversation, tweets, reviews, advertising language, bureaucratic language, sayings, questions etc. ` +
