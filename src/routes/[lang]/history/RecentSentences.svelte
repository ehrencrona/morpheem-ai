...
<div class="grid grid-cols-1 md:grid-cols-2 w-full gap-x-4 text-base">
	{#each showAll ? sentences : sentences.slice(0, 6) as sentence}
		<div class="bg-light-gray rounded-md px-4 py-3 w-full mb-4 font-sans">
			{sentence.sentence}
		</div>
	{/each}
</div>
...
{#if sentences.length > 6}
	<SpinnerButton
		...
		className="underline text-blue-3 text-sm mb-2"
	>
