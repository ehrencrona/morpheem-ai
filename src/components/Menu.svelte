<script lang="ts">
	...
	import { getLanguageOnClient } from '../routes/[lang]/api/api-call';
	import Hamburger from './Hamburger.svelte';
	import { languages } from '../constants';

	$: baseUrl = `/${getLanguageOnClient().code}`;
...
{#if isMobileOpen}
	...
	>
		<div class="h-full w-[200px] bg-white flex flex-col flex-wrap">
			...
			<div class="p-4">
				<a href="mailto:andreas.ehrencrona@velik.it" class="block mb-4 text-sm underline text-xs"> Contact </a>
